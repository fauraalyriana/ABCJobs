...
<form action="editedByAdmin" method="post">
	<div class="row border rounded-3 p-3 mb-4">
        ...
        <div class="col-8">
        	<div class="form-floating mb-3">
        		<input type="text" class="form-control" id="idUser" name="idUser" value="${user_id}" required>
...
<div class="mb-3 p-3 shadow">
	<div class="d-flex">
    	<h3>Information</h3>
        	<button type="button" style="background: #86A6DF; color: white" class="btn ms-auto" data-bs-toggle="modal" data-bs-target="#information"> Add Information</button>
    	<div class="modal fade" id="information" tabindex="-1" aria-labelledby="informationLabel" aria-hidden="true">
    	
    	<form action="update_informationByAdmin" method="post">
    	...
    	<div class="modal-dialog">
    		<div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                    	<input type="date" class="form-control" id="startDateEX" name="year">
